...
const SwitchMode = ({ darkMode, toggleDarkMode }) => {
    return (
        <div className="d-flex align-items-center justify-content-center" >
            <label className="toggle" htmlFor="switch">
                <input id="switch" className="input" type="checkbox" onClick={toggleDarkMode} />
                <div className="icon icon--moon">
                    <svg height="26" width="26" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
